...
- [ten1seven/**what-input**](https://github.com/ten1seven/what-input) - A global utility for tracking the current input method (mouse/pointer, keyboard or touch). `keyboard`  
...
- [egstad-construct/**detect-scroll**](https://github.com/egstad-construct/detect-scroll) - A performant and lightweight (~1.6kb) ES6 module for detecting scroll activity (direction + location) for X and/or Y axis. `scroll`  
...
- [flexdinesh/**browser-or-node**](https://github.com/flexdinesh/browser-or-node) - Check where your code is running. In the browser or in node.js environment. `environment`  
...
- [kepano/**defuddle**](https://github.com/kepano/defuddle) - Extract the main content from web pages. `extractor`  
