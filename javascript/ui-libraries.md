...
- [framework7io/**framework7**](https://github.com/framework7io/framework7) - Full featured HTML framework for building iOS & Android apps. **`vanilla`**  
...
- [fancyapps/**ui**](https://github.com/fancyapps/ui) - A library of JavaScript UI components, includes the best lightbox - Fancybox5. **`vanilla`**  
...
- [saadeghi/**daisyui**](https://github.com/saadeghi/daisyui) - The most popular, free and open-source Tailwind CSS component library. **`tailwind`**  
...
- [mdbootstrap/**Tailwind-Elements**](https://github.com/mdbootstrap/Tailwind-Elements) - Huge collection of Tailwind components, sections and templates. **`tailwind`**  
...
- [markmead/**hyperui**](https://github.com/markmead/hyperui) - Free Tailwind CSS v4 components for your next project, designed to enhance your web development with the latest features and styles. **`tailwind`**  
...
- [sailboatui/**sailboatui**](https://github.com/sailboatui/sailboatui) - Sailboat UI is a modern UI component library for Tailwind CSS. **`tailwind`**  
...
- [merakiuilabs/**merakiui**](https://github.com/merakiuilabs/merakiui) - Tailwind CSS components that support RTL languages & fully responsive based on Flexbox & CSS Grid with elegant Dark Mode. **`tailwind`** **`alpine`**  
...
- [MarsX-dev/**floatui**](https://github.com/MarsX-dev/floatui) - Beautiful and responsive UI components and templates for React and Vue (soon) with Tailwind CSS. **`tailwind`** **`react`** **`vue`**  
...
- [cschroeter/**park-ui**](https://github.com/cschroeter/park-ui) - Beautifully designed components built on Ark UI that work for the JS and CSS frameworks of your choice. **`react`** **`solid`**  
...
- [shadcn-ui/**ui**](https://github.com/shadcn-ui/ui) - Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source. **`tailwind`** **`react`**  
  ...
  - [haydenbleasel/**kibo**](https://github.com/haydenbleasel/kibo) - A custom registry of composable, accessible and open source shadcn/ui components. **`tailwind`** **`react`**  
...
- [nextui-org/**nextui**](https://github.com/nextui-org/nextui) - Beautiful, fast and modern React UI library. **`tailwind`** **`react`**  
...
- [mantinedev/**mantine**](https://github.com/mantinedev/mantine) - A fully featured React components library. **`react`**  
...
- [ariakit/**ariakit**](https://github.com/ariakit/ariakit) - Toolkit for building accessible web apps with React. **`react`**  
...
- [hirotomoyamada/**yamada-ui**](https://github.com/hirotomoyamada/yamada-ui) - React UI components of the Yamada, by the Yamada, for the Yamada built with React and Emotion. **`react`**  
...
- [lmsqueezy/**wedges**](https://github.com/lmsqueezy/wedges) - An ever-expanding, open-source React UI library built with the Wedges Design System, Radix primitives, and Tailwind CSS. **`tailwind`** **`react`**  
...
- [tremorlabs/**tremor-raw**](https://github.com/tremorlabs/tremor-raw) - Copy & Paste React components to build dashboards and modern web applications. **`tailwind`** **`react`**  
...
- [syntaxUI/**syntaxui**](https://github.com/syntaxUI/syntaxui) - Get free access to pre-built, Tailwind CSS-powered components, animations and effects - brought to life using Framer Motion. Just copy, paste and you're ready to go! **`tailwind`** **`react`**  
...
- [chakra-ui/**chakra-ui**](https://github.com/chakra-ui/chakra-ui) - Simple, Modular & Accessible UI Components for your React Applications. **`react`**  
...
- [magicuidesign/**magicui**](https://github.com/magicuidesign/magicui) - UI Library for Design Engineers. Animated components and effects you can copy and paste into your apps. Free. Open Source. **`react`**  
...
- [tamagui/**tamagui**](https://github.com/tamagui/tamagui) - Style React fast with 100% parity on React Native, an optional UI kit, and optimizing compiler. **`react`**  
...
- [radix-vue/**radix-vue**](https://github.com/radix-vue/radix-vue) - Vue port of Radix UI Primitives. An open-source UI component library for building high-quality, accessible design systems and web apps. **`vue`**  
...
- [selemondev/**spark-ui**](https://github.com/selemondev/spark-ui) - Experience The Magic Of Animated Components. Crafted With Vue, TypeScript, TailwindCss And Vueuse Motion. **`tailwind`** **`vue`**  
...
- [unovue/**inspira-ui**](https://github.com/unovue/inspira-ui) - Build beautiful website using Vue & Nuxt. **`tailwind`** **`vue`**  
...
- [melt-ui/**melt-ui**](https://github.com/melt-ui/melt-ui) - A set of headless, accessible component builders for Svelte. **`tailwind`** **`svelte`**  
...
- [thedevdojo/**pines**](https://github.com/thedevdojo/pines) - The Pines UI library. **`tailwind`** **`alpine`**  
